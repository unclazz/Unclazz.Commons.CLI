...
namespace Unclazz.Commons.CLI
{
	...
	public class HelpFormatter
	{
		...
		public string Format(ICommandLine cmdln)
		{
			return Render_Help(cmdln).ToString();
		}

		StringBuilder Render_Help(ICommandLine cmdln)
		{
		...
		StringBuilder Render_Syntax(ICommandLine cmdln)
		{
			var b = new StringBuilder();
		...
		StringBuilder Render_OptionNameAndArgName(IOption opt)
		{
		...
		StringBuilder Render_Option(IOption opt)
		{
